			...
			if (s.isEmpty() == false) {
				...
				if (isvip) {
					...
					if (cu.key == 0) {
						...
						System.out.println("线程id" + Thread.currentThread().getId() + "\t" + ThreadName + "---窗口无人，请"
								+ cu.num + "号【蔡成功】顾客准备！");
						System.out.println("线程id" + Thread.currentThread().getId() + "\t" + ThreadName + "---窗口"
								+ cu.num + "号【蔡成功】顾客就绪！");
						System.out.println("线程id" + Thread.currentThread().getId() + "\t" + ThreadName + "---窗口"
								+ cu.num + "号【蔡成功】顾客正在办理！");
						try {
